...
-- The DROP is required because the v2 signature differs from the
-- pre-retirement definition; wrap in a DO with set local to silence the
-- NOTICE emitted on fresh installs where the function never existed.
do $$
begin
